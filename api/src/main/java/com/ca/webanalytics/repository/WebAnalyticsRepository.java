...
/**
 * Site Analytics interface for repository methods
 * 
 * @author rkodali
 *
 */
public interface WebAnalyticsRepository {

	/**
	 * Get the Page Views for given site from the Dao
	 * @param website_id
	 * @return SiteAnaltics
	 */
	...
	/**
	 * Get the Page views for the given date range for given site id from the DAO
	 * @param website_id
	 * @param fromDate
	 * @param toDate
	...
	/**
	 * Get the Page Views for Given Date range, country code and site id from the DAO
	 * @param website_id
	 * @param countryCode
	 * @param fromDate
	 * @param toDate
	...
	/**
	 * Get the most popular page views across all the sites from the DAO
